...
Temperature = st.number_input("Temperature (℃)",step=0.1,min_value=0)
...
MCHC = st.number_input("MCHC (g/L)",step=0.1,min_value=0)
MCV = st.number_input("MCV (fL)",step=1,min_value=0)
RDW = st.number_input("RDW",step=0.1,min_value=0)
WBC = st.number_input("WBC (×109/L)",step=0.1,min_value=0)
