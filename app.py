...
Race = st.number_input("Race (white=1,black=2,others=3)",step=1,max_value=3)
Norepinephrine = st.number_input("Norepinephrine (No=0,Yes=1)",step=1,max_value=1)
Dopamine = st.number_input("Dopamine (No=0,Yes=1)",step=1,max_value=1)
Phenylephrine = st.number_input("Phenylephrine (No=0,Yes=1)",step=1,max_value=1)
Vasopressin = st.number_input("Vasopressin (No=0,Yes=1)",step=1,max_value=1)
Vent = st.number_input("Vent (No=0,Yes=1)",step=1,max_value=1)
Intubated = st.number_input("Intubated (No=0,Yes=1)",step=1,max_value=1)
MC = st.number_input("MC (No=0,Yes=1)",step=1,max_value=1)
HepF = st.number_input("HepF (No=0,Yes=1)",step=1,max_value=1)
