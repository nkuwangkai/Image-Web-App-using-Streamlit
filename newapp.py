...
if st.button("Predict"):
    ...
    X[['Race','Norepinephrine','Dopamine','Phenylephrine','Vasopressin','Vent','Intubated','MC','HepF']] = X[['Race','Norepinephrine','Dopamine','Phenylephrine','Vasopressin','Vent','Intubated','MC','HepF']].astype(categorical)
